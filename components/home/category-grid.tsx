...
export default function CategoryGrid() {
  const categories = [
    ...
    { name: "Uniforms", image: "/home/kids-home.webp?height=400&width=600", cols: "col-span-2", rows: "row-span-1" },
    { name: "Accessorios", image: "/home/acc-home.webp?height=400&width=600", cols: "col-span-2", rows: "row-span-1" },
  ]
...
function CategoryCard({ category, className }: CategoryCardProps) {
  return (
    <Link href={`/${category.name.toLowerCase()}`} className={`relative overflow-hidden ${className}`}>
