...
export const Uniform = [
  ...
  },
  {
    ...
    href: "/shop?category=corporate-uniforms",
  },
  {
    title: "Chef Uniform",
    href: "/shop?category=chef-uniform",
  },
  {
  ...
  return (
    <div className="sticky top-0 bg-white z-50">
      <div className="lg:min-w-[1250px] lg:max-w-[1920px] w-full flex justify-self-center justify-between place-items-center p-3">
        ...
        {/* Desktop Navigation */}
        <div className="hidden md:flex gap-11 text-sm text-[#333333] justify-between ml-10">
